...
export type TxListenerEventInfo<T extends TxListenerTypeEnum> = T extends TxListenerTypeEnum.ON_LIST_CHANGES ? Tx[] : T extends TxListenerTypeEnum.ON_UPDATE_TX ? {
    oldValue: Tx;
    newValue: Tx;
} : Tx;
